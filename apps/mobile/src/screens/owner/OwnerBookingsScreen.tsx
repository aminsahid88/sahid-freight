...
const styles = StyleSheet.create({
  ...
  trackBtn:       { backgroundColor: 'rgba(55,138,221,0.10)', borderRadius: 10, padding: 12, alignItems: 'center', borderWidth: 0.5, borderColor: 'rgba(55,138,221,0.35)' },
  trackBtnText:   { color: theme.blue, fontSize: 14, fontWeight: '500' },
  assignBtn:      { backgroundColor: 'rgba(239,159,39,0.10)', borderRadius: 10, padding: 13, alignItems: 'center', borderWidth: 0.5, borderColor: 'rgba(239,159,39,0.35)' },
  ...
  driverChip:     { backgroundColor: 'rgba(55,138,221,0.10)', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 5, alignSelf: 'flex-start' },
