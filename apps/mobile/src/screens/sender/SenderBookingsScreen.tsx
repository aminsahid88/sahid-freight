...
const styles = StyleSheet.create({
  ...
  bidCountBadge:  { backgroundColor: 'rgba(239,159,39,0.12)', borderRadius: 999, paddingHorizontal: 10, paddingVertical: 4, borderWidth: 0.5, borderColor: 'rgba(239,159,39,0.35)' },
  ...
  paidBadge:      { backgroundColor: theme.accentDim, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 5, borderWidth: 0.5, borderColor: 'rgba(151,196,89,0.35)' },
  paidText:       { fontSize: 13, fontWeight: '500', color: theme.accent },
  trackBtn:       { marginTop: 10, backgroundColor: 'rgba(55,138,221,0.12)', borderRadius: 10, padding: 12, alignItems: 'center', borderWidth: 0.5, borderColor: 'rgba(55,138,221,0.35)' },
