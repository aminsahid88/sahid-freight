...
const styles = StyleSheet.create({
  ...
  cardBidBadge:    { backgroundColor: 'rgba(239,159,39,0.12)', borderRadius: 999, paddingHorizontal: 8, paddingVertical: 3 },
  cardBidText:     { fontSize: 10, fontWeight: '500', color: '#EF9F27' },
  ...
  sheet:           { backgroundColor: '#0B0F0E', borderTopLeftRadius: 14, borderTopRightRadius: 14, padding: 16, paddingBottom: 32 },
  ...
  sheetRow:        { paddingVertical: 14, borderBottomWidth: 0.5, borderBottomColor: 'rgba(255,255,255,0.08)' },
