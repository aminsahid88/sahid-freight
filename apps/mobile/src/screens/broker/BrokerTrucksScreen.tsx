    ...
    <ScreenWrapper backgroundColor={BG}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.topBar}>
          <View>
            <Text style={styles.topBarTitle}>Trucks</Text>
            <Text style={styles.topBarSub}>Verified trucks across the network.</Text>
          </View>
          <NotificationBell navigation={navigation} />
        </View>

        <View style={styles.emptyCard}>
          <Feather name="truck" size={40} color={SUBTLE} style={{ marginBottom: 16 }} />
          <Text style={styles.emptyTitle}>No trucks online</Text>
          <Text style={styles.emptyBody}>
            When truck owners mark their trucks available, they'll appear here.
          </Text>
        </View>
      </ScrollView>
    </ScreenWrapper>
