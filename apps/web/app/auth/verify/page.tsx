...
export default function VerifyPage() {
  ...
  return (
    ...
    <div style={{ minHeight: "100vh", display: "flex", fontFamily: "'Inter, system-ui, sans-serif", background: "var(--bg)" }}>
      ...
      {/* Left panel */}
      <div className="verify-left" style={{ width: "52%", background: "#0A1F44", position: "relative", overflow: "hidden", display: "flex", flexDirection: "column", padding: "52px 60px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px", position: "relative", zIndex: 1 }}>
          <div style={{ width: "38px", height: "38px", background: "#3D7BFF", borderRadius: "10px", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
              <path d="M1 3h15v13H1z" stroke="#FFFFFF" strokeWidth="1.8" strokeLinejoin="round"/>
              <path d="M16 8h4l3 3v5h-7V8z" stroke="#FFFFFF" strokeWidth="1.8" strokeLinejoin="round"/>
              <circle cx="5.5" cy="18.5" r="2.5" stroke="#FFFFFF" strokeWidth="1.8"/>
              <circle cx="18.5" cy="18.5" r="2.5" stroke="#FFFFFF" strokeWidth="1.8"/>
            </svg>
          </div>
          <div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ marginTop: "48px", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px", padding: "20px" }}>
            <div style={{ fontSize: "11px", color: "#3D7BFF", letterSpacing: "2px", textTransform: "uppercase" as const, marginBottom: "8px" }}>Sent to</div>
            <div style={{ fontSize: "18px", fontWeight: "700", color: "#FFFFFF", fontFamily: "monospace" }}>{user?.email}</div>
          </div>
        </div>
      ...
      <div className="verify-right" style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "48px" }}>
        <div style={{ width: "100%", maxWidth: "400px" }}>
          <div className="verify-card" style={{ background: "var(--surface)", borderRadius: "20px", padding: "48px 44px", boxShadow: "0 2px 4px rgba(10,31,68,0.04), 0 16px 48px rgba(10,31,68,0.10)", border: "1px solid rgba(10,31,68,0.06)" }}>
            ...
            <div style={{ marginTop: "24px", paddingTop: "20px", borderTop: "1px solid #E2E8F0", textAlign: "center" as const }}>
